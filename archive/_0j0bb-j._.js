...
function CompanyPage() {
    ...
    const [lastTask, setLastTask] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    async function createOrg(e) {
        ...
        try {
            const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/api/organizations", {
                method: "POST",
                body: JSON.stringify({
                    name: f.get("name")
                })
    ...
    async function uploadKnowledge(e) {
        ...
        const f = new FormData(e.currentTarget);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/api/organizations/${org.id}/knowledge`, {
                method: "POST",
                body: JSON.stringify({
                    name: f.get("name"),
    ...
    async function createCampaign(e) {
        ...
        const f = new FormData(e.currentTarget);
        try {
            const c = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])("/api/campaigns", {
                method: "POST",
                body: JSON.stringify({
    ...
    async function draftTask(e) {
        ...
        const f = new FormData(e.currentTarget);
        try {
            const t = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/api/campaigns/${campaign.id}/tasks`, {
                method: "POST",
                body: JSON.stringify({
    ...
    async function approveTask() {
        ...
        setMsg("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/api/campaigns/${campaign.id}/tasks/${lastTask.id}/approve`, {
                method: "POST"
            });
            setLastTask({
                ...lastTask,
    ...
    async function recordDecision(e) {
        ...
        const f = new FormData(e.currentTarget);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"])(`/api/campaigns/${campaign.id}/candidates/${f.get("candidate_id")}/decision`, {
                method: "POST",
                body: JSON.stringify({
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    activeTab === "knowledge" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "panel side form",
                        style: {
                            marginTop: 20
                        },
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    lastTask && lastTask.status === "PENDING_APPROVAL" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            marginTop: 15,
                                            padding: 12,
                                            background: "#fff8ec",
...
_s(CompanyPage, "O+gk0rnh+G1gqE8FHkz2ypcHAsI=");
_c = CompanyPage;
var _c;
...
//# sourceMappingURL=_0j0bb-j._.js.map